...
import 'package:fitness_app/feature/meals/presentation/view_model/meal_state.dart';
...
class MealCubit extends Cubit<MealState> {
  MealCubit(this._getMealDetailsUseCase) : super(MealState(baseState: BaseInitialState()));
