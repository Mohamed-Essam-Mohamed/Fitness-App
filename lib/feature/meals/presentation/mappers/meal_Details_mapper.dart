...
class MealDetailsMapper {
  ...
  static List<NutritionEntity> get nutritionData => [
        NutritionEntity(
            label: AppValues.nutritionEnergy, value: AppValues.nutritionEnergyValue),
        NutritionEntity(
            label: AppValues.nutritionProtein, value: AppValues.nutritionProteinValue),
        NutritionEntity(
            label: AppValues.nutritionCarbs, value: AppValues.nutritionCarbsValue),
        NutritionEntity(
            label: AppValues.nutritionFat, value: AppValues.nutritionFatValue),
      ];
}
